...
## Chapter
The idea of Tidy data underlies principles in data management, and database administration that have been around for decades. Hadley Wickham, in 2014, started to formalize some of these rules in what he called "Principles for Tidy Data" These principles are focused mainly on how to follow some simple conventions for structuring data in a matrix (or table) to use in the statistical programming language `R` 
