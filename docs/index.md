...
- I have created this book in place of a traditional course site hosted on canvas. I am doing this so I can provide most of the text for what are typically lectures (audio and slides) in a form of written chapters. This makes skimming and digesting the material much easier, and will provide a sustainable resource that you can return to at any time in the future. This book will be downloadable, and all of the course content will remain sustainably accessible to you in the future.

![](https://i.imgflip.com/3ukrj1.jpg)
...
There are two sections of this class. The first section (weeks 1-4) follows the typical structure of an iSchool online course. The second section of the class (weeks 5-10)  includes lectures and readings, but the major focus of your work is executing a final project. Practically the two sections of the course breakdown as follows:   
...
- Open discussions have two forms - you can participate in a Canvas discussion with your colleagues (I have created a discussion thread for each of week of class), and I will host an open office hour each week. I'll record these via Zoom so that if you are not able to attend you can see what was discussed.

**Exercises Week 1-4**: Each week I will post an exercise that asks you to engage with open data. This might include restructuring a dataset, using a tool, or practicing some skill that is applicable to our weekly topic. A list of exercises are found below.

**Weekly content Week 5-10**: In the second section of this class each week will include: 1. Readings (required and optional); 2. Written chapters; and 3. Recorded lectures. The difference is that in weeks 5-10 you will meet with me (or check-in via email) about steps taken to complete your final assignment. This provides an opportunity for you to work with me more directly - asking questions or clarifications - in exercises. I will work with you or your group to schedule a convenient time to meet each week.

**Protocol Assignments Week 5-10**: Each week I will post an exercise that you or your group are to complete in advance of our meeting. This will become clearer as the quarter moves along - but just keep in mind that your exercises or assignments in the second section of the class are in service of a final project.

## Weekly Overview

| Week | Topic                                   | Readings | Exercises             | Chapter | Lecture |
|------|-----------------------------------------|----------|-----------------------|---------|---------|
| 0    | Class Introduction                      | None     | Read Syllabus         |  [0]()  |         |
| 1    | Tables, Trees, and Triples              |          | [Cookie Recipes]()    |         |         |
| 2    | Tidy Data                               |          | [Tidy cookie data]()  |         |         |
...
- Exercises: Weeks 1-4 have a practical exercise component that asks you to apply some concept that is covered in the Chapter or Lecture. You need to complete these by following the directions in each exercise. Completing each exercise is a credit / no-credit mark. Give an earnest effort and you will receive credit. (40% of your final grade)

- Protocol Assignments: Weeks 5-10 has a protocol related assignment that is due each week. If you complete these before our weekly meetings I can give you feedback and help you structure these so that they are useful to you. You only need to complete these by including them in your final protocol deliverable. (20% of your final grade)

- Protocol: The final assignment that is due on or before `June 06 2020` - The assignment is described in detail in another section. In short, the assignment asks you to envision curating and archiving a set of open data that are topically relevant. The final protocol can be turned in a variety of formats, but must include all of the components described on the assignment page to be given full credit. (40% of your final grade)
